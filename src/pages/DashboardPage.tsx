    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4 lg:gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium truncate">Total</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mt-1 sm:mt-2">{stats.totalCanastillas}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 sm:mt-2 hidden sm:block">Inventario total</p>
              </div>
              <div className="w-10 h-10 sm:w-14 sm:h-14 bg-primary-100 dark:bg-primary-900/30 rounded-xl flex items-center justify-center flex-shrink-0 ml-2">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium truncate">Disponibles</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-600 mt-1 sm:mt-2">{stats.disponibles}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 sm:mt-2">{disponiblesPercent}%</p>
              </div>
              <div className="w-10 h-10 sm:w-14 sm:h-14 bg-green-100 dark:bg-green-900/30 rounded-xl flex items-center justify-center flex-shrink-0 ml-2">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium truncate">Alq. Interno</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-purple-600 mt-1 sm:mt-2">{stats.enAlquilerInterno}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 sm:mt-2">{alquilerInternoPercent}%</p>
              </div>
              <div className="w-10 h-10 sm:w-14 sm:h-14 bg-purple-100 dark:bg-purple-900/30 rounded-xl flex items-center justify-center flex-shrink-0 ml-2">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium truncate">Alq. Externo</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-pink-600 mt-1 sm:mt-2">{stats.enAlquilerExterno}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 sm:mt-2">{alquilerExternoPercent}%</p>
              </div>
              <div className="w-10 h-10 sm:w-14 sm:h-14 bg-pink-100 dark:bg-pink-900/30 rounded-xl flex items-center justify-center flex-shrink-0 ml-2">
          ...
          {/* Card 5 - En Lavado */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow col-span-2 sm:col-span-1">
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium truncate">En Lavado</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-cyan-600 mt-1 sm:mt-2">{stats.enLavado}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 sm:mt-2">{lavadoPercent}%</p>
              </div>
              <div className="w-10 h-10 sm:w-14 sm:h-14 bg-cyan-100 dark:bg-cyan-900/30 rounded-xl flex items-center justify-center flex-shrink-0 ml-2">
