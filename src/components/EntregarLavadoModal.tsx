    ...
    try {
      ...
      if (currentUser) {
        await logAuditEvent({
          ...
          action: 'UPDATE',
          module: 'lavado',
          description: `Entrega de lavado - Orden #${order.order_number || order.id} (Remisión: ${remisionDevolucion})`,
          details: { orden_id: order.id, numero_orden: order.order_number, remision_devolucion: remisionDevolucion },
        })
      }
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
          className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-full max-w-[calc(100%-2rem)] sm:max-w-lg mx-4 sm:mx-auto"
